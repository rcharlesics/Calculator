...
Item {
    ...
    //COLOR shadowColor
    property color shadowColor: GreenHouseThemeManager.theme.color("shadowColor")
    ...
    //COLOR innerShadowRectColor
    property color borderColor: GreenHouseThemeManager.theme.color("innerShadowRectColor")
    ...
    Rectangle {
        ...
        radius: root.radius
        color: GreenHouseThemeManager.theme.color("innerShadowRectColor")

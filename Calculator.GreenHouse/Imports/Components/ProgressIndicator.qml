...
Item {
    ...
    property string backgroundSource: GreenHouseThemeManager.theme.asset("/placeholders/progress/background.png")
    ...
    property string indicatorSource: GreenHouseThemeManager.theme.asset("/placeholders/progress/fill.png")
